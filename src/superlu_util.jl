...
const superlu_options_fields = Dict(fieldname(superlu_options_t,i)=>(fieldoffset(superlu_options_t,i), fieldtype(superlu_options_t,i)) for i = 1:fieldcount(superlu_options_t))
